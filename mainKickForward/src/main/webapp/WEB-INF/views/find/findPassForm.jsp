...
<body>
	...
	<div class="login-form">
		...
		<form:form modelAttribute="user" name='findPassForm' method='post' action='findPass'>
			<img src="/webapp/resources/image/logo.png" class="logo">
			<h4 class="modal-title">비밀번호 찾기</h4>

			<span class="fieldError" align='center'>${errMsg}</span>
			<div class="form-group">
				<form:input path="id" maxlength="20" class="form-control" placeholder="ID" />
				<span class="fieldError"> <form:errors path="id" />
				</span>
			...
			<a href="findId">아이디 찾기 |</a> <a href="join">회원가입</a>
		</div>

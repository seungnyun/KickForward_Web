...
<body id="page-top">
	...
	<div class="container"><br>
		...
		<table>
			<tr>
				<th>작성자</th>
				<td>${Breakdownview.writerId}</td>
			</tr>
			<tr>
				<th>제목</th>
				<td>${Breakdownview.title}</td>
			</tr>

			<tr>
				<th>킥보드 일련번호&nbsp;</th>
				<td>${Breakdownview.kbnumber}</td>
			</tr>

			<tr>
				<th>킥보드 위치</th>
				<td>${Breakdownview.location}</td>
			</tr>

			<tr>
				<th>고장사유</th>
				<td>${Breakdownview.content}</td>
			</tr>
		...
		<c:choose>
			<c:when test="${loginAdmin.id eq Breakdownview.writerId}">
			
				
			</c:when>
		
		</c:choose><br><br><br><br><br><br><br><br><br><br><br><br><br><br>


		<a href="javascript:history.back();" class="write-link" style = "text-decoration-line: none">목록 페이지</a>

...
<link rel="stylesheet" type="text/css" href="../webapp/resources/css/styles.css">
		...
		<table class="table table-sm">
			...
			<tbody>
				<c:forEach var="result" items="${gpsList}" varStatus="status">
					<tr>
						<td>${result.no}</td>
						<td><a href="#" onclick="fnCmdEdit('${result.no}')">${result.serialnumber}</a></td>
						<td>${result.in_use}</td>						
						<!-- <td><a href="#" onclick="fnCmdEdit('${result.no}')">수정</a></td> -->
						<td><a href="#" onclick="fnCmdDelete('${result.no}')">삭제</a></td>											
					</tr>						
				</c:forEach>
			</tbody>
		</table>

...
<body>
	...
	<div class="container">
		...
		<form action="join" method="post" id="writeForm">
			...
			<p>
				<input type="submit" class="buttonButton" value="회원가입">
				<input type="button" class="buttonButton" value="취소" onclick="history.back()">
				<input type="button" class="buttonButton" value="새로고침" onclick="location.reload()"> 
			</p>
		</form>
	</div>

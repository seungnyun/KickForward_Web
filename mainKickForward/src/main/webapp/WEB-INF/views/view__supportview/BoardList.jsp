			...
			<ul id="pageInfo" class="pageInfo">
				...
				<c:if test="${pageMaker.prev}">
					<li class="pageInfo_btn previous"><a
						href="/list?pageNum=${pageMaker.startPage - 1}&amount=${pageMaker.cri.amount}">Previous</a>
					</li>
				</c:if>
				...
				<c:forEach var="num" begin="${pageMaker.startPage}"
					...
					<li class="pageInfo_btn"><a
						href="/list?pageNum=${num}&amount=${pageMaker.cri.amount}" style = "text-decoration-line: none">${num}</a></li>
				</c:forEach>

				<!--다음 페이지 이동 버튼 -->
				<c:if test="${pageMaker.next}">
					<li class="pageInfo_btn next"><a
						href="/list?pageNum=${pageMaker.endPage + 1}&amount=${pageMaker.cri.amount}">Next</a>
					</li>
				</c:if>
			</ul>
		</div>

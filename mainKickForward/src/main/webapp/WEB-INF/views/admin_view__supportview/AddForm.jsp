...
<body id="page-top">
	...
	<div class="container">
		<form:form modelAttribute="board" name="boardAdd" method="post"
			action="addSave">
			<br>
			<br>
			<br>
			<h3 class="center-heading" style="text-align: center;">공지사항 등록</h3>
			<br>
			<table border="1">
				...
				<tr>
					...
					<td><form:input path="title" size="70"
							placeholder="제목을 입력해 주세요." /> <span class="fieldError"><form:errors
								path="title" /></span></td>
				</tr>

				<tr>

					<td><form:input path="writerId" size="70"
							value="${loginAdmin.id}" readonly="true" /> <span
						class="fieldError"><form:errors path="writerId" /></span></td>
				</tr>

				<tr>

					<td><form:textarea path="content" rows="15" cols="73"
							placeholder="내용을 입력해 주세요." /> <span class="fieldError"><form:errors

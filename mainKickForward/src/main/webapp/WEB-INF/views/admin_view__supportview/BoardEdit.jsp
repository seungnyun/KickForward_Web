...
<body id="page-top">
	...
	<div class="container">
	    <form:form modelAttribute="board" name="boardEdit" method="post" action="editSave">
	    <input type="hidden" name="bno" value="${board.bno}" /><br>
	        <h3 class="center-heading" style="text-align: center;">게시글 수정</h3><br>
	        <table border="1">
	        
	         	<tr>	               
	                <td>
	                    <form:input path="title" size="70" value="${board.title}" placeholder="제목을 입력해 주세요." /> 
	            ...
	            <tr>	               
	                <td>
	                    <form:input path="writerId" size="70" value="${board.writerId}" placeholder="내용을 입력해 주세요." readonly="true"/>
	            ...
	            <tr>	                
	                <td>
	                    <form:textarea path="content" rows="15" cols="73" id="content" />

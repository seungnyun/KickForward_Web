...
.intro_bg {
	background-image: url("/webapp/resources/assets/img/service5.jpg");
	width: 100%;
	height: 824px;
}
...
<body id="page-top">
		...
		<div class="container px-5">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<div class="intro_text">
					...
					<h4 class="contents1">킥포워드가 이동 방식의 변화를 만들어갑니다.</h4>
				</div>
				...
				<div class="col-lg-6">
					...
					<div class="mb-5 mb-lg-0 text-center text-lg-start">
						<h1 class="display-1 lh-1 mb-3">Let's do it with the Kick
							Forward!</h1>
						<p class="lead fw-normal text-muted mb-5">질 좋은 킥보드와 뛰어난 성능으로
							지금 만나보세요!</p>
	...
	<div class="main_text1"
		...
		<div class="main_text1_text" style="text-align: center;">킥포워드로 이동하며 바람을 느끼세요</div>
	</div>
	...
	<section id="features">
		<div class="row gx-5 justify-content-center text-center">
			<div class="col-xl-8">
				<div class="h2 fs-1 text-black mb-4">"킥포워드의 기능을 소개합니다."</div>
			</div>
		</div>
		<div class="container px-5">
			<div class="row gx-5 align-items-center">
						...
						<div class="row gx-5">
							<div class="col-md-6 mb-5">
								...
								<div class="text-center">
									...
									<p class="text-muted mb-0">신식의 기능으로 간편하게 사용 가능합니다.</p>
								</div>
							</div>
							<div class="col-md-6 mb-5">
								<!-- Feature item-->

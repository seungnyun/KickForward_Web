...
.intro_bg {
	background-image: url("/webapp/resources/image/pretty.jpg");
	width: 100%;
	height: 765px;
}
		...
		<div class="main_text1">
			...
			<div class="service">
				...
				<div class="contents2">
					...
					<h2>STEP1 <h4>음주측정</h4></h2>
					<br>
					킥보드를 이용하기 전 음주측정을 해야합니다<br>
				</div>
			</div>
		</div>
		...
		<div class="main_text2">
			...
			<div class="service2">
				...
				<div class="contents2">
					...
					<h2>STEP2 <h4>음주측정 검증</h4></h2>
					
					<br>
					음주측정 통과 시 킥보드 사용이 가능합니다<br>
		...
		<div class="main_text1">
			...
			<div class="service">
				...
				<div class="contents2">
					...
					<h2>STEP5 <h4>킥보드 반납</h4></h2>
					<br>
					킥보드 반납 후 안전한 곳에 주차해주세요<br>
				</div>
			</div>
		</div>
